...
6. `ScanService.start_scan`: genera `scan_id` (UUID v4), arma `N8nPayload`.
...
11. Dashboard React/Node.js muestra resultados en tiempo real (fuera del alcance de este proyecto).
