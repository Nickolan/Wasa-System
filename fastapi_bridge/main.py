...
Expone únicamente `GET /health` en este estadio. Los routers de dominio
(`api/v1/auth`, `api/v1/scan`) existen como módulos pero no se montan acá
todavía — ver D-8 en `openspec/changes/fastapi-bridge-scaffold/design.md`.
