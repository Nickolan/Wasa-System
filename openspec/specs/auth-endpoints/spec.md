...
Define las operaciones de autenticación del FastAPI Bridge: registro de nuevos usuarios y verificación de credenciales. Son el primer paso del flujo de acceso autorizado a los escaneos de seguridad, y el contrato entre el frontend autenticado del sistema WASA y el servicio backend.
